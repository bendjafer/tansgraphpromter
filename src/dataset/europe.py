...
class EuropeDataset(Dataset):
    ...
    def processed_file_names(self):
        return [
            'dataset/tape_europe/processed/data.pt',
            'dataset/tape_europe/processed/text.csv',
        ]
    ...
    def get_idx_split(self):
        ...
        return {
            'train': _load('dataset/tape_europe/split/train_indices.txt'),
            'val':   _load('dataset/tape_europe/split/val_indices.txt'),
            'test':  _load('dataset/tape_europe/split/test_indices.txt'),
        }


if __name__ == '__main__':
    dataset = EuropeDataset()
    print(dataset.graph)
